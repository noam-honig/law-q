...
אני מצהיר ומאשר כי עבודתי בתוכנית היא התנדבותית, על כל המשתמע בכך, לרבות בחינת הפניות שאקבל מהלשכה, החלטתי אם לסרב לטפל בפניות ו/או לטפל בפניות לגופן, היקף הטיפול ותוכנו. עבודתי זו (ואף לאחר מכן) תהיה תחת אחריותי המקצועית והבלעדית, וכי ידוע לי שלשכת עורכי הדין לא תהא אחראית על כל טענה שיעלה לקוח בקשר לטיפול בפנייתו. הריני מתחייב כי אם תעלה טענה ו/או תוגש תביעה ו/או דרישה נגד לשכת עורכי בגין עניין הקשור לפנייה ולאופן הטיפול או הסירוב לטפל בה, אני אשפה את הלשכה מיד עם דרישתה הראשונה בגין כל נזק ו/או הוצאה ו/או הפסד שיגרמו לה בקשר לאמור, בכפוף למתן פסק דין חלוט שמטיל אחריות על הלשכה בגין האמור.
    `)
    )
  }
